...
def generate_key():
    ...
    key_path = os.path.join(CRYPT_FOLDER, "secret2.key")
...
def encrypt_password(password):
    ...
    enc_password_path = os.path.join(CRYPT_FOLDER, "encrypted_password2.txt")
...
encrypt_password("Metro1998.2050")  # Replace with the actual password
